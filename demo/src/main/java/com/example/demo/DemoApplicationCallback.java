...
@Controller
@ComponentScan
public class DemoApplicationCallback implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(DemoApplicationCallback.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(DemoApplicationCallback.class, args);
